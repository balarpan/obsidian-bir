...
const tagStr = ${props.companyName ? '"Person/Company/'  + (props.companyCountry ? props.companyCountry+'/' : '') + sanitizeName(props.companyName.replace(this.myPlugin.settings.formOfPropertyRegexp, '$2 $1').replaceAll('"', '')) + '"' : 'Person'};
